...
async def sync_courses():
    ...
    # Update Foundational Course to 'both'
    # We will fetch and update manually to avoid the cryptic error
    ...
    if foundational:
        ...
        print("Updated Foundational Course track to 'both'")
    ...
    for c_data in new_courses:
        ...
        if not exists:
            ...
            print(f"Created: {c_data['title']}")
        else:
            print(f"Exists: {c_data['title']}")
