...
const WellnessHomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-28 pb-12 px-6 bg-gradient-to-b from-sky/5 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Badge className="mb-4 bg-sky/10 text-sky hover:bg-sky/20 font-dm-sans">
              Wellness Track
            </Badge>
                  ...
                  >
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className="flex items-start justify-between mb-4">
                        <Badge 
                          variant="outline" 
                          className="font-dm-sans text-xs capitalize border-sky/30 text-sky"
                        >
                          {course.level}
                        </Badge>
                      ...
                      <h3 className="text-xl font-playfair font-semibold text-navy-900 mb-2 group-hover:text-sky transition-colors">
                        {course.title}
                      </h3>
